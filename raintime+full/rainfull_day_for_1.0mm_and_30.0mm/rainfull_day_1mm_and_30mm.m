...
%%讀取檔案
rainfull_day = xlsread('rainfull_day_1.0mm_and_30.0mm.xlsx');
...
% title('雨日 1.0mm~30.0mm(1月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(1月)','jpg')
% 
% figure(2)
% plot(year,month_2,'LineWidth',1,'Color','b','Marker','.');
% yline(average_2,'-k')
% axis([1947,2022,0,30])
% title('雨日 1.0mm~30.0mm(2月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(2月)','jpg')
% 
% figure(3)
...
% title('雨日 1.0mm~30.0mm(3月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(3月)','jpg')
% 
% figure(4)
% plot(year,month_4,'LineWidth',1,'Color','b','Marker','.');
% yline(average_4,'-k')
% axis([1947,2022,0,30])
% title('雨日 1.0mm~30.0mm(4月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(4月)','jpg')
% 
% figure(5)
...
% title('雨日 1.0mm~30.0mm(5月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(5月)','jpg')
% 
% figure(6)
...
% title('雨日 1.0mm~30.0mm(6月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(6月)','jpg')
% 
% figure(7)
% plot(year,month_7,'LineWidth',1,'Color','b','Marker','.');
% yline(average_7,'-k')
% axis([1947,2022,0,30])
% title('雨日 1.0mm~30.0mm(7月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(7月)','jpg')
% 
% figure(8)
...
% title('雨日 1.0mm~30.0mm(8月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(8月)','jpg')
% 
% figure(9)
% plot(year,month_9,'LineWidth',1,'Color','b','Marker','.');
% yline(average_9,'-k')
% axis([1947,2022,0,30])
% title('雨日 1.0mm~30.0mm(9月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(9月)','jpg')
% 
% figure(10)
% plot(year,month_10,'LineWidth',1,'Color','b','Marker','.');
% yline(average_10,'-k')
% axis([1947,2022,0,30])
% title('雨日 1.0mm~30.0mm(10月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(10月)','jpg')
% 
% figure(11)
% plot(year,month_11,'LineWidth',1,'Color','b','Marker','.');
% yline(average_11,'-k')
% axis([1947,2022,0,30])
% title('雨日 1.0mm~30.0mm(11月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(11月)','jpg')
% 
% figure(12)
...
% title('雨日 1.0mm~30.0mm(12月)');ylabel('天數(日)');xlabel('時間(time)')
% saveas(gcf,'rainfull_day_1mm_and_30mm_(12月)','jpg')
...
sgtitle('降雨量介於1.0mm~30.0mm的日數折線圖')
saveas(gcf,'rainfull_day_1mm_and_30mm_(all)','jpg')
%--------------------------------------------------------------------------