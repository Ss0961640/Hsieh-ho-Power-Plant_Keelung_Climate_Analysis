...
% *2022/Aug/14*
%
% Thanks to JoséMiguel Jáuregui and NAYXA for funding the following changes
%
...
%%
% 
%   [figure_handle, count, speeds, directions, Table, Others] = WindRose(dir, spd, 'anglenorth', 0, 'angleeast', 90, 'labels', {'N (0°)', 'E (90°)', 'S (180°)', 'W (270°)'}, 'freqlabelangle', 45);
%
...
[figure_handle, count, speeds, directions, Table, Others] = WindRose(dir, spd, 'labels', {'North (90°)', 'East (0°)', 'South (270°)', 'West (180°)'});
%%
...
% # *Others*: _STRUCTURE_. Dimensions *1×1*. A structure with several parameters that can be useful to generate similar WindRoses. For the moment, this structure includes:
%
%   a)	*Others.MaxFrequency*: _DOUBLE_. Dimensions *1×1*. Maximum frequency of the outer ring.
%
%   b)	*Others.nFrequencies*: _DOUBLE_. Dimensions *1×1*. Number of frequency rings appearing in the figure.
%
%   c)  *Others.freqs*: _DOUBLE_. Dimensions *1×n*. Value of frequency rings appearing in the figure.
